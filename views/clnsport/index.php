        ...
        [            
            ...
            'columns' => [
                    ...
                    [
                        ...
                        'urlCreator'=>function($action, $model, $key, $index) {  return 'index.php?r=clnsport/'.$action.'&id='.$key; },
                        'viewOptions'=>['title'=>'This will launch the sport details page.', 'data-toggle'=>'tooltip'],   
                        'updateOptions'=>['title'=>'This will launch the sport update page.', 'data-toggle'=>'tooltip'],
