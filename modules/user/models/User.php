...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'status'      => Yii::t('user', 'สถานะ'),
            'email'       => Yii::t('user', 'อีเมล์'),
            'new_email'   => Yii::t('user', 'อีมล์ใหม่'),
            'username'    => Yii::t('user', 'ชื่อผู้ใช้'),
    ...
    */
    ...
    public function beforeSave($insert)
    {
        ...
        if ($this->ban_time) {
            $this->ban_time = new Expression('CURRENT_TIMESTAMP');
        }
    ...
    public function updateLoginMeta()
    {
        ...
        $this->login_time = new Expression('CURRENT_TIMESTAMP');
